...
public class categoryNews_1 extends Fragment{
    String address = "";
    String chk = "1";
    String result = "";
    BackgroundTask task;
    ...
    {
        RelativeLayout layout = (RelativeLayout) inflater.inflate(R.layout.fragment_category_1, container, false);
        return layout;
    }
    @Override
    ...
    class BackgroundTask extends AsyncTask<Integer, Integer, Integer> {
        protected void onPreExecute() {
            address = "http://211.112.85.72:8000/polls/crawl/정치";
        }
