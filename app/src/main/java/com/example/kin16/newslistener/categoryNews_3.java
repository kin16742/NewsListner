...
public class categoryNews_3 extends Fragment{
    String address = "";
    String chk = "1";
    String result = "";
    BackgroundTask task;
    TextView tvk, tvj;
    public categoryNews_3(){}
    ...
    {
        RelativeLayout layout = (RelativeLayout) inflater.inflate(R.layout.fragment_category_3, container, false);
        return layout;
    }
    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState){
        ...
        String test;
        tvk = getActivity().findViewById(R.id.tv1_6);
        ...
        if(test.equals(chk)) {
            ...
            for (int i = 1; i <= 10; i++) {
                ...
                int k = getResources().getIdentifier("tv" + i + "_6", "id", getActivity().getPackageName());
                int j = getResources().getIdentifier("tv" + i + "_1_6", "id", getActivity().getPackageName());
    ...
    class BackgroundTask extends AsyncTask<Integer, Integer, Integer> {
        protected void onPreExecute() {
            address = "http://211.112.85.72:8000/polls/crawl/사회";
        }
