...
public class categoryNews_5 extends Fragment{
    String address = "";
    String chk = "1";
    String result = "";
    BackgroundTask task;
    TextView tvj, tvk;
    public categoryNews_5(){}
    ...
    {
        RelativeLayout layout = (RelativeLayout) inflater.inflate(R.layout.fragment_category_5, container, false);
        return layout;
    }
    @Override
    ...
    class BackgroundTask extends AsyncTask<Integer, Integer, Integer> {
        protected void onPreExecute() {
            address = "http://211.112.85.72:8000/polls/crawl/세계";
        }
