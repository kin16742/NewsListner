...
public class categoryNews_6 extends Fragment{
    String address = "";
    String chk = "1";
    String result = "";
    BackgroundTask task;
    TextView tvk, tvj, tvh;
    public categoryNews_6(){}
    ...
    {
        RelativeLayout layout = (RelativeLayout) inflater.inflate(R.layout.fragment_category_6, container, false);
        return layout;
    }
    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState){
        ...
        String test;
        tvk = getActivity().findViewById(R.id.tv1_8);
        ...
        if(test.equals(chk)) {
            ...
            for (int i = 1; i <= 10; i++) {
                ...
                int k = getResources().getIdentifier("tv" + i + "_8", "id", getActivity().getPackageName());
                int j = getResources().getIdentifier("tv" + i + "_1_8", "id", getActivity().getPackageName());
                int h = getResources().getIdentifier("tv" + i + "_2_8", "id", getActivity().getPackageName());
    ...
    class BackgroundTask extends AsyncTask<Integer, Integer, Integer> {
        protected void onPreExecute() {
            address = "http://211.112.85.72:8000/polls/crawl/IT";
        }
