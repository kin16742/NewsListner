...
public class categoryNews_8 extends Fragment{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState){
        ...
        String test;
        tvk = getActivity().findViewById(R.id.tv1_11);
        ...
        if(test.equals(chk)) {
            ...
            for (int i = 1; i <= 10; i++) {
                ...
                int k = getResources().getIdentifier("tv" + i + "_11", "id", getActivity().getPackageName());
                int j = getResources().getIdentifier("tv" + i + "_1_11", "id", getActivity().getPackageName());
