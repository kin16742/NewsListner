...
public class categoryNews_8 extends Fragment{
    String address = "";
    String chk = "1";
    String result = "";
    BackgroundTask task;
    TextView tvk, tvj, tvh;
    public categoryNews_8(){}
    ...
    {
        RelativeLayout layout = (RelativeLayout) inflater.inflate(R.layout.fragment_category_8, container, false);
        return layout;
    }
    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState){
        ...
        String test;
        tvk = getActivity().findViewById(R.id.tv1_10);
        ...
        if(test.equals(chk)) {
            ...
            for (int i = 1; i <= 10; i++) {
                ...
                int k = getResources().getIdentifier("tv" + i + "_10", "id", getActivity().getPackageName());
                int j = getResources().getIdentifier("tv" + i + "_1_10", "id", getActivity().getPackageName());
                int h = getResources().getIdentifier("tv" + i + "_2_10", "id", getActivity().getPackageName());
    ...
    class BackgroundTask extends AsyncTask<Integer, Integer, Integer> {
        protected void onPreExecute() {
            address = "http://211.112.85.72:8000/polls/crawl/스포츠";
        }
