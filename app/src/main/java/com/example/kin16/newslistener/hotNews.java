...
public class hotNews extends Fragment{
    ...
    {
        RelativeLayout layout = (RelativeLayout) inflater.inflate(R.layout.fragment_hotnews, container, false);
        return layout;
    }
    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        String test;
        tvk = getActivity().findViewById(R.id.tv1_2);
        ...
        if(test.equals(chk)) {
            ...
            for (int i = 1; i <= 10; i++) {
                ...
                int k = getResources().getIdentifier("tv" + i + "_2", "id", getActivity().getPackageName());
                int j = getResources().getIdentifier("tv" + i + "_1_2", "id", getActivity().getPackageName());
                int h = getResources().getIdentifier("tv" + i + "_2_2", "id", getActivity().getPackageName());
    ...
    class BackgroundTask extends AsyncTask<Integer, Integer, Integer> {
        protected void onPreExecute() {
            address = "http://211.112.85.72:8000/polls/popular";
        }
